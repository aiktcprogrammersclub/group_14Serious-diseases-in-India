...
function kopa_front_after_setup_theme() {
    ...
    if (!is_admin()) {
        ...
        add_filter('excerpt_length', 'kopa_excerpt_length', 999);
...
function kopa_excerpt_length($length) {
    $length = 55;
    return $length;
}
...
function kopa_front_enqueue_scripts() {
    if (!is_admin()) {
         ...
         * --------------------------------------------------
         */
        wp_enqueue_style('kopa-font-awesome', "{$dir}/library/css/font-awesome.css", array(), NULL);
        wp_enqueue_style('kopa-reset', $dir . '/css/reset.css', array(), NULL);
        wp_enqueue_style('kopa-bootstrap', "{$dir}/library/css/bootstrap.css", array(), NULL);
        wp_enqueue_style('kopa-bootstrap-responsive', "{$dir}/library/css/bootstrap-responsive.css", array(), NULL);
        ...
        wp_enqueue_style('kopa-owl-carousel', $dir . '/css/owl.carousel.css', array(), NULL);
        wp_enqueue_style('kopa-owl-theme', $dir . '/css/owl.theme.css', array(), NULL);
        ...
        wp_enqueue_script('kopa-bootstrap', "{$dir}/library/js/bootstrap.js", array('jquery'), NULL, TRUE);
        wp_enqueue_script('kopa-bootstrap-tooltip', $dir . '/library/js/bootstrap.tooltip.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('kopa-jquery-flickrfeed', $dir . '/js/jquery.flickrfeed.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('kopa-jquery-caroufredsel', $dir . '/js/jquery.caroufredsel.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('kopa-jquery-easing', $dir . '/js/jquery.easing.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('kopa-jquery-eislideshow', $dir . '/js/jquery.eislideshow.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('kopa-jquery-flexslider', $dir . '/js/jquery.flexslider.js', array('jquery'), NULL, TRUE);
        ...
        wp_enqueue_script('kopa-jquery-validate', $dir . '/js/jquery.validate.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('kopa-jquery-sequence', $dir . '/js/jquery.sequence.js', array('jquery'), NULL, TRUE);
        ...
        wp_enqueue_script('kopa-jquery-imagesloaded', $dir . '/js/jquery.imagesloaded.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('kopa-owl-carousel', $dir . '/js/owl.carousel.js', array('jquery'), NULL, TRUE);
         ...
         * --------------------------------------------------
         */
        wp_localize_script('kopa-custom', 'kopa_custom_front_localization', array(
            'validate' => array(
                'form' => array(
...
function kopa_get_image_sizes() {
    $sizes = array(
        'kopa-image-size-0' => array(300, 300, TRUE, __('Small (Kopa)', kopa_get_domain())),
        'kopa-image-size-1' => array(385, 232, TRUE, __('Medium (Kopa)', kopa_get_domain())),
        'kopa-image-size-2' => array(795, 413, TRUE, __('Elastic Slide (Kopa)', kopa_get_domain())),
        'kopa-image-size-3' => array(518, 369, TRUE, __('Squence Slide (Kopa)', kopa_get_domain())),
        'kopa-image-size-4' => array(160, 30, TRUE, __('Client Logo (Kopa)', kopa_get_domain())),
        'kopa-image-size-5' => array(63, 63, TRUE, __('Staff Avatar (Kopa)', kopa_get_domain())),
        'kopa-image-size-6' => array(255, 255, TRUE, __('255x255 (Kopa)', kopa_get_domain()))
    );
                                        ...
                                        <li style="width: 245px;">
                                            <article class="entry-item clearfix">
                                                    ...
                                                    switch (get_post_format()) :
                                                        ...
                                                        default:
                                                            if (get_post_format() == 'quote')
                                                                $icon = KopaIcon::getIcon('fa fa-quote-right', 'i');
                                                            elseif (get_post_format() == 'audio')
                                                                $icon = KopaIcon::getIcon('fa fa-music', 'i');
                                                            else
                                                                $icon = KopaIcon::getIcon('fa fa-link', 'i');
                                                            ?>
                                                            <div class="mask">
                                                                <a class="link-detail" href="<?php the_permalink(); ?>"><?php echo $icon; ?></a>
                                                            </div>
                                                            <?php
                                                            if (has_post_thumbnail())
                                                                the_post_thumbnail('kopa-image-size-1');
                                                ...
                                                <div class="entry-content">
                                                    ...
                                                    <p class="entry-meta">
                                                        <span class="entry-date"><?php echo KopaIcon::getIcon('fa fa-calendar-o entry-icon', 'span'); ?><span><?php echo get_the_date(); ?></span></span>
                                                        <span class="entry-comment"><?php echo KopaIcon::getIcon('fa fa-comment-o entry-icon', 'span'); ?><?php comments_popup_link(__('0', kopa_get_domain()), __('1', kopa_get_domain()), __('%', kopa_get_domain()), '', __('Comments Off', kopa_get_domain())); ?></span>
                                                    </p>                                                    
                                                </div><!--entry-content-->
                                            </article><!--entry-item-->
                                        </li>
        ...
        <div class="socials-link-container clearfix">
            <ul class="socials-link clearfix">
                <?php if ($display_facebook_sharing_button == 'show') : ?>
                    <li class="facebook-icon"><a href="http://www.facebook.com/share.php?u=<?php echo urlencode(get_permalink()); ?>" title="Facebook" target="_blank"><?php echo KopaIcon::getIcon('fa fa-facebook', 'span'); ?></a></li>
                <?php endif; ?>
                <?php if ($display_twitter_sharing_button == 'show') : ?>
                    <li class="twitter-icon"><a href="http://twitter.com/home?status=<?php echo get_the_title() . ':+' . urlencode(get_permalink()); ?>" title="Twitter" target="_blank"><?php echo KopaIcon::getIcon('fa fa-twitter', 'span'); ?></a></li>
                <?php endif; ?>
                <?php if ($display_google_sharing_button == 'show') : ?>
                    <li class="google-icon"><a href="https://plus.google.com/share?url=<?php echo urlencode(get_permalink()); ?>" title="Google" target="_blank"><?php echo KopaIcon::getIcon('fa fa-google-plus', 'span'); ?></a></li>
                <?php endif; ?>
                <?php if ($display_linkedin_sharing_button == 'show') : ?>
                    <li class="linkedin-icon"><a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo urlencode(get_permalink()); ?>&amp;title=<?php echo urlencode(get_the_title()); ?>&amp;summary=<?php echo urlencode(get_the_excerpt()); ?>&amp;source=<?php echo urlencode(get_bloginfo('name')); ?>" title="Linkedin" target="_blank"><?php echo KopaIcon::getIcon('fa fa-linkedin', 'span'); ?></a></li>
                <?php endif; ?>
                <?php if ($display_pinterest_sharing_button == 'show') : ?>
                    <li class="pinterest-icon"><a href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode(get_permalink()); ?>&amp;media=<?php echo isset($thumbnail[0]) ? urlencode($thumbnail[0]) : ''; ?>&amp;description=<?php the_title(); ?>" title="Pinterest" target="_blank"><?php echo KopaIcon::getIcon('fa fa-pinterest', 'span'); ?></a></li>
                <?php endif; ?>
                <?php if ($display_email_sharing_button == 'show') : ?>
                    <li class="facebook-icon"><a href="mailto:?subject=<?php echo urlencode($email_subject); ?>&amp;body=<?php echo urlencode($email_body); ?>" title="Email" target="_self"><?php echo KopaIcon::getIcon('fa fa-envelope-o', 'span'); ?></a></li>
                <?php endif; ?>
            </ul>
        </div>
        <?php
                    ...
                    if ($social_links['facebook'] || $social_links['twitter'] || $social_links['google-plus']):
                        ...
                        <ul class="clearfix social-link">                      
                            ...
                            <?php if ($social_links['facebook']): ?>
                                <li class="facebook-icon"><a target="_blank" title="<?php _e('Facebook', kopa_get_domain()); ?>" href="<?php echo $social_links['facebook']; ?>"><?php echo KopaIcon::getIcon('fa fa-facebook', 'i'); ?></a></li>
                            <?php endif; ?>
                            <?php if ($social_links['twitter']): ?>
                                <li class="twitter-icon"><a target="_blank" title="<?php _e('Twitter', kopa_get_domain()); ?>" class="twitter" href="<?php echo $social_links['twitter']; ?>"><?php echo KopaIcon::getIcon('fa fa-twitter', 'i'); ?></a></li>
                            <?php endif; ?>
                            <?php if ($social_links['google-plus']): ?>
                                <li class="gplus-icon"><a target="_blank" title="<?php _e('Google+', kopa_get_domain()); ?>" class="twitter" href="<?php echo $social_links['google-plus']; ?>"><?php echo KopaIcon::getIcon('fa fa-google-plus', 'i'); ?></a></li>
                            <?php endif; ?>                            
                        </ul><!--social-link-->
                    <?php endif; ?>
                </header>
...
function kopa_get_template_setting() {
    ...
    if (is_home()) {
        ...
        } else if (is_tax('portfolio_project') || is_tax('portfolio_tag') || is_post_type_archive('portfolio')) {
...
function kopa_head() {
    ...
    <!--[if IE 7]>
        ...
        <link rel="stylesheet" href="<?php echo get_template_directory_uri() . '/css/sequencejs-theme.modern-slide-in.ie.css'; ?>">
    <![endif]-->   
    ...
    $kopa_theme_options_main_nav_sub_font_size = get_option('kopa_theme_options_main_nav_sub_font_size');
    if ($kopa_theme_options_main_nav_sub_font_size) {
        echo "<style>
         #main-menu li ul li a {
            font-size: {$kopa_theme_options_main_nav_sub_font_size}px;
        }
        </style>";
    }
    ...
    $kopa_theme_options_custom_css = esc_html(stripslashes(get_option('kopa_theme_options_custom_css')));
