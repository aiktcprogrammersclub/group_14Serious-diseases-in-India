/*!
 * Kopatheme widget.js (http://kopatheme.com)
...
function kopa_shortcode_icon_click(shortcode, textarea) {
    ...
    switch (shortcode) {
        ...
        case 'three_fourth':
            ...
            break;
        case 'dropcaps':
            textarea.insertAtCaret('[dropcaps]', '[/dropcaps]');
            break;
        case 'button':
            textarea.insertAtCaret('[button size="e.g. small, big" color="e.g. orange, green, blue, black" link="" target=""]', '[/button]');
            break;
        case 'alert':
        ...
        case 'accordions':
            ...
            break;
        case 'toggle':
            textarea.insertAtCaret('[toggle title=""]', '[/toggle]', '');
            break;
        case 'contact_form':
