            ...
            success: function(data) {
                ...
                if (data.is_exist) {
                    ...
                    var temp_html = '<tr>' +
                            ...
                            '</td>' +
                            '<td>' +
                            '<a onclick="kopa_remove_sidebar_clicked(jQuery(this),\'' + data.sidebar_id + '\')" title="" lang="" rel="tooltip" class="button button-basic button-icon" data-original-title="Remove"><i class="fa fa-trash-o"></i></a>' +
                            '</td>' +
                            '</tr>';
...
function on_change_icon(obj, icon) {
    var wrap = obj.parents('.kopa_option_box');
    wrap.find(".icon_class").val(icon);
