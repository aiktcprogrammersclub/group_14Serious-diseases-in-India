...
if (!function_exists('kopa_add_sidebar')) {
    ...
    function kopa_add_sidebar() {
        ...
        if (!empty($_POST['new_sidebar_name'])) {
            ...
            $found_sidebar = false;
            foreach ($KOPA_SIDEBARS as $e_sidebar_id => $e_sidebar_name) {
            ...
            if ($found_sidebar) {
                ...
                $KOPA_SIDEBARS[$sidebar_id] = $kopa_sidebar_name;
                update_option("kopa_sidebar", $KOPA_SIDEBARS);
            }
        }
        exit();
    }
...
if (!function_exists('save_sidebar_setting')) {
    ...
    function save_sidebar_setting() {
        ...
        if (!empty($_POST[kopa_sidebar])) {
            ...
            global $KOPA_SIDEBARS;
            $kopa_sidebar_existing = $KOPA_SIDEBARS;
...
if (!function_exists('kopa_ajax_send_contact')) {
    ...
    function kopa_ajax_send_contact() {
        ...
        $message_body = __("Name:", kopa_get_domain()) . " $name \n";
        $message_body .= __("Message:", kopa_get_domain()) . " $message \n";

        if (isset($_POST['url'])) {
            $website = $_POST["url"];
            if (!empty($website)) {
                $message_body .= __("Website:", kopa_get_domain()) . " $website";
            }
        }
        ...
        if (wp_mail($to, $subject, $message_body, $headers)) {
            $result = '<span class="success">' . __('Success! Your email address has been sent.', kopa_get_domain()) . '</span>';
        }
        ...
        if (!empty($_POST['pid'])) {
            ...
            if ($turn_on):
                ...
                <?php if ('show' === $sharing_buttons['twitter']): ?>
                    <a href="<?php echo 'https://twitter.com/share';?>" class="twitter-share-button" data-lang="en"></a>     
            ...
            switch (get_post_format()) {
                case 'quote':
                    ...
                    <article class="timeline-item quote-post clearfix">                                                    
                        <div class="timeline-icon">
                            <div><?php echo KopaIcon::getIcon('fa fa-quote-left post-type', 'span'); ?></div>
                        ...
                        <div class="entry-body clearfix">                                                    
                            ...
                            <header>
                                <span class="entry-date"><?php echo KopaIcon::getIcon('fa fa-calendar-o entry-icon', 'span'); ?><span><?php echo get_the_date(); ?></span></span></span>
                ...
                case 'video':
                    ...
                    <article class="timeline-item video-post clearfix">                                                    
                        <div class="timeline-icon">
                            <div><?php echo KopaIcon::getIcon('fa fa-play post-type', 'span'); ?></div>
                            <span class="dotted-horizon"></span>
                            <span class="vertical-line"></span>
                            <span class="circle-outer"></span>
                            <span class="circle-inner"></span>
                            ...
                            <div class="kp-thumb hover-effect">
                                <?php if (isset($video[0]['url'])): ?>
                                    <div class="mask" onclick="jQuery(this).find('a.link-detail').click();">
                                        <a href="<?php echo $video[0]['url'] ?>" rel="prettyPhoto" class="link-detail"><?php echo KopaIcon::getIcon('fa fa-play', 'span'); ?></a>
                                    </div>
                                <?php endif; ?>
                                <?php
                ...
                case 'gallery':
                    ...
                    <article class="timeline-item gallery-post clearfix">                                                    
                        <div class="timeline-icon">
                            <div><?php echo KopaIcon::getIcon('fa fa-search-plus post-type', 'span'); ?></p></div>
                            <span class="dotted-horizon"></span>
                            <span class="vertical-line"></span>
                            <span class="circle-outer"></span>
                            <span class="circle-inner"></span>
                ...
                case 'audio':
                    ...
                    <article class="timeline-item audio-post clearfix">                                                    
                        <div class="timeline-icon">
                            <div><?php echo KopaIcon::getIcon('fa fa-music post-type', 'span'); ?></div>
                            <span class="dotted-horizon"></span>
                            <span class="vertical-line"></span>
                            <span class="circle-outer"></span>
                            <span class="circle-inner"></span>
                ...
                default:
                    ...
                    if (has_post_thumbnail())
                        ...
                        ?> clearfix">
                        <div class="timeline-icon">
                            <div><?php echo KopaIcon::getIcon('fa fa-link post-type', 'span'); ?></div>
                            <span class="dotted-horizon"></span>
                            <span class="vertical-line"></span>
                            <span class="circle-outer"></span>
                            <span class="circle-inner"></span>
                            ...
                            <?php if (has_post_thumbnail()): ?>
                                <div class="kp-thumb hover-effect">
                                    <div class="mask" onclick="window.location = '<?php echo $post_url; ?>';">
                                        <a class="link-detail" href="<?php echo $post_url; ?>"><?php echo KopaIcon::getIcon('fa fa-link', 'span'); ?></a>
                                    </div>
