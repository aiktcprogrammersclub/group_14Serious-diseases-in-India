<div class="kopa-content-box tab-content tab-content-1" id="tab-general">
    ...
    <div class="kopa-box-body">
        <div class="kopa-element-box kopa-theme-options">
            ...
            <p class="kopa-desc">               
               <?php printf(__('Click <a href="%s">here</a> to upload your logo.', kopa_get_domain()), admin_url('themes.php?page=custom-header')); ?>
            </p>
        ...
        <div class="kopa-element-box kopa-theme-options">
            ...
            <div class="clearfix">
                ...
                <button class="left btn btn-success upload_image_button" alt="kopa_theme_options_favicon_url"><?php echo KopaIcon::getIcon('fa fa-upload', 'span'); ?><?php _e('Upload', kopa_get_domain()); ?></button>
            </div>
        </div><!--kopa-element-box-->
        <div class="kopa-element-box kopa-theme-options">
            ...
            <div class="clearfix">
                ...
                <button class="left btn btn-success upload_image_button" alt="kopa_theme_options_apple_iphone_icon_url"><?php echo KopaIcon::getIcon('fa fa-upload', 'span'); ?><?php _e('Upload', kopa_get_domain()); ?></button>
            </div>
            ...
            <div class="clearfix">
                ...
                <button class="left btn btn-success upload_image_button" alt="kopa_theme_options_apple_iphone_retina_icon_url"><?php echo KopaIcon::getIcon('fa fa-upload', 'span'); ?><?php _e('Upload', kopa_get_domain()); ?></button>
            </div>
            ...
            <div class="clearfix">
                ...
                <button class="left btn btn-success upload_image_button" alt="kopa_theme_options_apple_ipad_icon_url"><?php echo KopaIcon::getIcon('fa fa-upload', 'span'); ?><?php _e('Upload', kopa_get_domain()); ?></button>
            </div>
            ...
            <div class="clearfix">
                ...
                <button class="btn btn-success upload_image_button" alt="kopa_theme_options_apple_ipad_retina_icon_url"><?php echo KopaIcon::getIcon('fa fa-upload', 'span'); ?><?php _e('Upload', kopa_get_domain()); ?></button>
            </div>
        </div>  
    </div>
    <div class="kopa-box-head">
    ...
    <div class="kopa-box-body">
        ...
        <div class="kopa-element-box kopa-theme-options">
            ...
            <textarea class="" rows="6" id="kopa_setting_copyrights" name="kopa_theme_options_copyright"><?php echo esc_html(stripslashes(get_option('kopa_theme_options_copyright'))); ?></textarea>
        </div><!--kopa-element-box-->        
    </div>
