...
?>
	...
	<div class="donate-info">
		...
		<a title="<?php esc_attr_e( 'Rate Advertica Lite', 'invert' ); ?>" href="<?php echo esc_url($sktratelink); ?>" target="_blank" class="review"><?php _e( 'Rate Advertica Lite', 'invert' ); ?></a>
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			<form action="options.php" method="post">
				<div id="skt-of-header"><div class="skt-of-logo"></div><h2>SketchThemes Admin Panel</h2></div>
				<div id="skt-of-body">
				...
				<input type="submit" id="advertica_submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'invert' ); ?>" />
			</form>
		</div> <!-- / #container -->
	</div>
